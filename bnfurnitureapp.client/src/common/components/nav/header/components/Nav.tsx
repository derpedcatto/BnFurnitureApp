...
function useCategoriesWithTypes() {
  const { categoriesWithTypes, isLoading: isCategoriesWithTypesLoading } =
    useFetchCategoriesWithTypes();

  return { categoriesWithTypes, isCategoriesWithTypesLoading };
}

const HamburgerMenuComponent: React.FC<HamburgerMenuProps> = React.memo(
  ({ list }) => {
...
const Nav = React.memo(() => {
  ...
  const { categoriesWithTypes, isCategoriesWithTypesLoading } = useCategoriesWithTypes();
      ...
      <nav className={styles.navbar}>
        <div className={styles.navLeft}>
          ...
          {isCategoriesWithTypesLoading ? (
            ...
            <HamburgerMenuComponent list={categoriesWithTypes} />
          )}
