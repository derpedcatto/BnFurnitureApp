...
//    options.UseMySql(connectionString, b => b.MigrationsAssembly("BnFurniture.Infrastructure"));
//});

builder.Services.AddDbContext<ApplicationDbContext>(options =>
{
    options.UseMySql(connectionString, serverVersion, b => b
        .MigrationsAssembly("BnFurniture.Infrastructure"));
});
...
// Устанавливаем порт 7249
app.Urls.Clear(); // Убираем все другие порты
app.Urls.Add("https://localhost:7249");
