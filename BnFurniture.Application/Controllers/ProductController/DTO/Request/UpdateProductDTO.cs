...
public class UpdateProductDTOValidator : AbstractValidator<UpdateProductDTO>
{
    ...
    public UpdateProductDTOValidator(ApplicationDbContext dbContext)
    {
        _dbContext = dbContext;

        RuleFor(x => x.Id)
            .MustAsync(IsProductIdValid).WithMessage("Invalid Product ID.");
    ...
    private async Task<bool> IsProductIdValid(Guid id, CancellationToken ct)
    {
        return await _dbContext.Product.AnyAsync(a => a.Id == id, ct);
    }
