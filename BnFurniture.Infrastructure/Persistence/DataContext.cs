...
namespace ASP_Work.Data
{
    public class DataContext:DbContext
    {
        public DbSet<Entity.AuditLog> AuditLog { get; set; }
        public DbSet<Entity.Characteristics> Characteristics { get; set; }
        public DbSet<Entity.CharacteristicsValue> CharacteristicsValue { get; set; }
        public DbSet<Entity.Order> Order { get; set; }
        public DbSet<Entity.OrderItem> OrderItem { get; set; }
        public DbSet<Entity.OrderStatus> OrderStatus { get; set; }
        public DbSet<Entity.PasswordResetToken> PasswordResetToken { get; set; }
        public DbSet<Entity.Permission> Permission { get; set; }
        public DbSet<Entity.Product> Product { get; set; }
        public DbSet<Entity.ProductArticle> ProductArticle { get; set; }
        public DbSet<Entity.ProductArticleOrderItem> ProductArticleOrderItem { get; set; }
        public DbSet<Entity.ProductCategory> ProductCategory { get; set; }
        public DbSet<Entity.ProductCharacteristicConfiguration> ProductCharacteristicConfiguration { get; set; }
        public DbSet<Entity.ProductMetrics> ProductMetrics { get; set; }
        public DbSet<Entity.ProductReview> ProductReview { get; set; }
        public DbSet<Entity.ProductSet> ProductSet { get; set; }
        public DbSet<Entity.ProductSetCategory> ProductSetCategory { get; set; }
        public DbSet<Entity.ProductSetItem> ProductSetItem { get; set; }
        public DbSet<Entity.ProductType> ProductType { get; set; }
        public DbSet<Entity.User> User { get; set; }
        public DbSet<Entity.User_UserRole> User_UserRole { get; set; }
        public DbSet<Entity.UserActivityType> UserActivityType { get; set; }
        public DbSet<Entity.UserRole> UserRole { get; set; }
        public DbSet<Entity.UserRole_Permission> UserRole_Permission { get; set; }
        public DbSet<Entity.UserWishlist> UserWishlist { get; set; }
        public DbSet<Entity.UserWishlistItem> UserWishlistItem { get; set; }
